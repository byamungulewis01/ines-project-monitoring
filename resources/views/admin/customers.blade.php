                        ...
                        <div class="col-sm-auto">
                            <div class="d-flex flex-wrap align-items-start gap-2">
                                ...
                                <button type="button" class="btn btn-primary add-btn"
                                    data-action="{{ route('customers.store') }}" data-bs-toggle="modal" id="create-btn"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" min="0" name="tin_number" value="{{ old('tin_number') }}" id="tin_number"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.remove-item-btn', function() {
                var route = "{{ route('customers.destroy', ['customer' => ':id']) }}";
