                        ...
                        <table class="table table-borderless mb-0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-muted">{{ \Carbon\Carbon::parse($student->completion_date)->format('d M, Y') }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="pt-3 border-top border-top-dashed mt-1">
                        <div class="hstack flex-wrap gap-2 fs-15">
                            <div class="ms-3">
                                <h6 class="fs-15 mb-0"><a href='{{ asset('storage/' . $student->project->proposal_file) }}'>Project
                                        Proposal.pdf</a></h6>
                            </div>
